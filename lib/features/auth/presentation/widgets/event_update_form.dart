...
class EventUpdateForm extends StatefulWidget {
  ...
  @override
  EventUpdateFormState createState() => EventUpdateFormState();
}

class EventUpdateFormState extends State<EventUpdateForm> {
  ...
  void initState() {
    ...
    _description = widget.eventDescription;
    ...
    _descriptionController = TextEditingController(text: widget.eventDescription);
  ...
  Future<void> _handleEventUpdate() async {
    // Show loading indicator
    _showLoadingIndicator();

    try {
      await widget.updateEvent.updateEvent(
        eventId: _eventId,
        name: _name,
      ...
      if (mounted) {
        ...
        // Pop the current screen (close the EventUpdatePage)
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return const Dialog(
          ...
          child: LoadingIndicator(message: 'Event Updating...'),
        );
      },
    );
  }
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText:
                      _isDescriptionValid ? null : 'Please enter description',
                  border: const OutlineInputBorder(),
                ),
                onChanged: (value) {
                  _description = value;
              ...
              ListTile(
                ...
                subtitle: Text(
                  ...
                  style: TextStyle(
                    color: _isRegistrationDeadlineValid
                        ? Colors.black
                        : Colors.red,
                  ),
                ),
